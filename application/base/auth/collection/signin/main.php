...
defined('MIDRUB_BASE_AUTH_SIGNIN_VERSION') OR define('MIDRUB_BASE_AUTH_SIGNIN_VERSION', '0.0.2');
    ...
    public function load_hooks($category) {
        ...
        switch ($category) {
            ...
            case 'admin_init':
                ...
                if ( (md_the_component_variable('component') === 'frontend') && ($this->CI->input->get('component', true) === 'signin') ) {
