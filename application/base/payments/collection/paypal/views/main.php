...
<script src="https://www.paypal.com/sdk/js?client-id=<?php echo get_option('paypal_client_id'); ?>&vault=true&disable-card=amex,visa,mastercard" data-namespace="paypal_sdk"></script>