                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="input-option">
                                        <textarea placeholder="<?php echo $this->lang->line('frontend_enter_code_used_header'); ?>" class="form-control settings-textarea-value" data-option="frontend_header_code"><?php echo get_option('frontend_header_code'); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
