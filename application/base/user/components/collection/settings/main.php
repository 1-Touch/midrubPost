...
defined('MIDRUB_BASE_USER_COMPONENTS_SETTINGS_VERSION') OR define('MIDRUB_BASE_USER_COMPONENTS_SETTINGS_VERSION', '0.2');
    ...
    public function load_hooks( $category ) {
        ...
        switch ($category) {
            ...
            case 'admin_init':
                ...
                if ( ( $this->CI->input->get('component', true) === 'settings') && (md_the_component_variable('component_display') === 'components' ) ) {
