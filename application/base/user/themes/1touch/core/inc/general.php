...
add_hook(
    ...
    function () {
        ...
        echo "<script src=\"" . base_url('assets/base/user/themes/1touch/js/main.js') . "\"></script>\n";
...
add_hook(
    ...
    function () {
        ...
        $this->CI->load->ext_model( MIDRUB_BASE_USER . 'themes/1touch/models/', 'Blue_notifications_model', 'blue_notifications_model' );
...
add_hook(
    ...
    function () {
        ...
        // Load Tickets Model
        $this->CI->load->ext_model( MIDRUB_BASE_USER . 'themes/1touch/models/', 'Blue_tickets_model', 'blue_tickets_model' );
