...
<head>
    ...
    <!-- Midrub CSS -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/base/user/themes/1touch/styles/css/style.css?ver=' . MD_VER); ?>" media="all" />
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/base/user/themes/1touch/styles/css/custom.css?ver=' . MD_VER); ?>" media="all" />
                        ...
                        <li>
                            <div class="header-left">
                                <div class="input-group icons">
                                   <a class="nue-white-button" href="<?php echo site_url('user/app/posts'); ?>"><?php echo $this->lang->line('theme_new_post'); ?></a>
                                </div>
                            </div>
                        </li>
                    </ul>
