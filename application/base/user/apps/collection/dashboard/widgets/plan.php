            ...
            'widget' => '<div class="col-xl-' . $plan_data[0]['size'] . '">'
                            . '<div class="card custom-color-white">'
                                . '<div class="card-body">'
                                    ...
                                    . '</div>'
                                    . '<h1>' . $plan_data[0]['plan_name']
                                    . '<span>' . $plan_data[0]['header'] . '</span></h1>'
                                . '</div>'
                                . '<div class="row">'
                                    . '<div class="col-xl-12">'
                                        . '<div class="stats-bottom">'
                                            ...
                                            . '</div>'
                                            . '<div class="progress">'
                                                . '<div class="progress-bar' . $color . ' cuto_bar" role="progressbar" style="width: ' . $time_left . '%" aria-valuenow="' . $time_left . '" aria-valuemin="0" aria-valuemax="100"></div>'
                                            . '</div>'
                                        . '</div>'
                                    . '</div>'
                                . '</div>'
