    ...
    public function display_widget( $user_id, $plan_end, $plan_data ) {
        ...
        return array(
            'widget' => '<div class="col-xl-' . $plan_data[0]['size'] . '">'
                            . '<div class="card custom-color-white">'
                                . '<div class="card-body">'
                                    . '<div class="icon4">'
                                        . '<i class="fa fa-inbox"></i>'
                                    . '</div>'
                                        . '<h1>' . $this->CI->lang->line('storage')
                                        . '<span>' . $this->CI->lang->line('total_available_storage') . '</span></h1>'
                                . '</div>'
                                . '<div class="row">'
                                    . '<div class="col-xl-12">'
                                        . '<div class="stats-bottom">'
                                            ...
                                            . '</div>'
                                            . '<div class="progress">'
                                                . '<div class="progress-bar' . $color . ' cuto_bar" role="progressbar" style="width: ' . $free_space . '%" aria-valuenow="' . $free_space . '" aria-valuemin="0" aria-valuemax="100"></div>'
                                            . '</div>'
                                        . '</div>'
                                    . '</div>'
                                . '</div>'
