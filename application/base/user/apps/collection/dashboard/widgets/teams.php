            ...
            'widget' => '<div class="col-xl-' . $plan_data[0]['size'] . '">'
                            . '<div class="card custom-color-white">'
                                . '<div class="card-body">'
                                    ...
                                    . '</div>'
                                        . '<h1>' . $this->CI->lang->line('teams')
                                        . '<span>' . $this->CI->lang->line('all_teams_members') . '</span></h1>'
                                . '</div>'
                                . '<div class="row">'
                                    . '<div class="col-xl-12">'
                                        . '<div class="stats-bottom">'
                                            ...
                                            . '</div>'
                                            . '<div class="progress">'
                                                . '<div class="progress-bar' . $color . ' cuto_bar" role="progressbar" style="width: ' . $members_left . '%" aria-valuenow="' . $members_left . '" aria-valuemin="0" aria-valuemax="100"></div>'
                                            . '</div>'
                                        . '</div>'
                                    . '</div>'
                                . '</div>'
