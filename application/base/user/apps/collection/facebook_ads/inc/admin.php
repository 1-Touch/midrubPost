...
set_admin_app_options(
    ...
    array (
        ...
        array (
            'type' => 'checkbox_input',
            'slug' => 'app_facebook_ads_enable',
            'label' => $this->lang->line('enable_app'),
            'label_description' => $this->lang->line('if_is_enabled')
        ), array (
            'type' => 'checkbox_input',
            'slug' => 'app_facebook_ads_enable_posts_boosting',
            'label' => $this->lang->line('fb_ads_enable_posts_boosting'),
            'label_description' => $this->lang->line('fb_ads_enable_posts_boosting_description')
        )
