...
set_member_permissions(
    ...
    array(
        'name' => $this->lang->line('facebook_advertising'),
        ...
        'fields' => array(
            ...
            array (
                'type' => 'checkbox_input',
                'slug' => 'facebook_ads',
                'label' => $this->lang->line('facebook_advertising_allow'),
                'label_description' => $this->lang->line('facebook_advertising_allow_if_enabled')
            )
